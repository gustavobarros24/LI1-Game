module Tarefa4_2021li1g075_Spec where
...
testsT4 =
  test
    ...
    , "Tarefa 4 - Teste movimentos Jogador cai mais que um bloco" ~:
     Jogo
        [ [Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio]
        , [Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Bloco]
        , [Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Bloco]
        ...
        (Jogador (5, 3) Oeste False) ~=? correrMovimentos m3e3 [AndarEsquerda]
    , "Tarefa 4 - Teste movimentos Jogador cai mais que um bloco com Caixa" ~:
     Jogo
        [ [Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio]
        , [Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Bloco]
        , [Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Bloco]
        ...
        (Jogador (5, 3) Oeste True) ~=? correrMovimentos m3e4 [AndarEsquerda]
    ]